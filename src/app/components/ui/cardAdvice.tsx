...
export const CardAdvice = ({text, numberAdvice}: Props) => {
    return(
        <div className="w-96 md:w-7/12 h-80 md:h-96 rounded-lg flex flex-col justify-center items-center shadow-lg bg-gray-900 p-14 rounded-lg mt-10 mb-10 gap-8">
